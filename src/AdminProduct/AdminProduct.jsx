...
export default function AdminProduct() {
   ...
   const handleAddToMen = () => {
    navigate("/adminMenProduct"); 
  };

   const handleAddToWomen = () => {
    navigate("/adminWomenProduct"); 
  };

   const handleAddToChild = () => {
    navigate("/adminChildProduct"); 
  };

    const AdminOrder = () => {
    navigate("/adminOrderTracking"); 
  };
  ...
  return (
    ...
    <div className="flex space-x-5">
      <h1 onClick={handleAddToMen} className="text-blue-500 hover:text-blue-800 cursor-pointer">Add Men product |</h1>
      <h1 onClick={handleAddToWomen} className="text-blue-500 hover:text-blue-800 cursor-pointer">Add women product |</h1>
      <h1 onClick={handleAddToChild} className="text-blue-500 hover:text-blue-800 cursor-pointer">Add child product |</h1>
      <h1 onClick={AdminOrder} className="text-blue-500 hover:text-blue-800 cursor-pointer">Admin Orders Update |</h1>
    </div>
